...
namespace Pantenna
{
    internal class Constants
    {
        ...
        public const float PANEL_POS_Y = 630.0f;
        public const float PANEL_WIDTH = 420.0f;
        public const float PANEL_HEIGHT = 200.0f;
        public const float PADDING = 10.0f;

        public const float SHIP_ICON_OFFS_X = 0.0f;
        public const float TRAJECTORY_ICON_OFFS_X = 30.0f;
        public const float DISTANCE_ICON_OFFS_X = 70.0f;
        public const float DISPLAY_NAME_ICON_OFFS_X = 140.0f;
